...
│   └── public/                       # Real-time dashboard UI, transaction feeds, audit logs
├── orchestrator/                     # Local Autonomous Orchestration
│   └── local-orchestrator.js         # Local autonomous purchase and execution pipeline
