      ...
      "text-translate": {
        ...
        generate(reqId, payload = {}) {
          return {
            ...
            targetLanguage:  payload.targetLanguage || "Hindi",
            translatedText:  `[Alpha] ${payload.text || "The quick brown fox"} → (translated to ${payload.targetLanguage || "Hindi"})`,
      ...
      "text-translate": {
        ...
        generate(reqId, payload = {}) {
          return {
            ...
            sourceText:      payload.text || "The quick brown fox",
            targetLanguage:  payload.targetLanguage || "Hindi",
            translatedText:  `[Beta] ${payload.text || "The quick brown fox"} → (translated to ${payload.targetLanguage || "Hindi"})`,
      ...
      "text-translate": {
        ...
        generate(reqId, payload = {}) {
          return {
            ...
            sourceText:      payload.text || "The quick brown fox",
            targetLanguage:  payload.targetLanguage || "Hindi",
            translatedText:  `[Gamma/Premium] ${payload.text || "The quick brown fox"} → (translated to ${payload.targetLanguage || "Hindi"})`,
