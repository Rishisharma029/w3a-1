 ...
 * - 9 Categories
 * - 22 Provider Nodes (14 Core + 8 Real API-Backed)
 * - 60 Functional x402 Autonomous Services (52 Core + 8 Real API-Backed)
...
$providers = [
  ...
  [
    'id' => 'open-meteo',
    'name' => 'Open-Meteo Global Forecasting',
    'description' => 'High-resolution open meteorological forecast API across global coordinates.',
    'service_type' => 'data-compute',
  ...
  [
    'id' => 'currencylayer-fx',
    'name' => 'CurrencyLayer Real-Time Forex',
    'description' => 'Reliable exchange rate conversion and live quotes across 168 global currencies.',
    'service_type' => 'data-compute',
  ...
  [
    'id' => 'ipstack-geo',
    'name' => 'IPStack Geolocation Intelligence',
    'description' => 'Precision IP lookup, latitude/longitude, ISP metadata, and country-level geo-routing.',
    'service_type' => 'data-compute',
  ...
  [
    'id' => 'giphy-media',
    'name' => 'Giphy Dynamic Media & GIF Engine',
    'description' => 'Official world-scale animated GIF search, trending reels, and sticker catalog access.',
    'service_type' => 'image-video',
  ...
  [
    'id' => 'apiflash-render',
    'name' => 'ApiFlash Cloud Screenshot Renderer',
    'description' => 'Chrome-based full-page screenshot capture, PDF rendering, and visual regression snapshots.',
    'service_type' => 'vision-ocr',
  ...
  [
    'id' => 'amazon-scraper',
    'name' => 'Amazon E-Commerce Data Scraper',
    'description' => 'Direct ASIN product data extraction, pricing, seller ratings, and inventory status.',
    'service_type' => 'data-compute',
  ...
  [
    'id' => 'blitapp-cloud',
    'name' => 'Blitapp Visual Monitoring & Snapshots',
    'description' => 'Scheduled website visual captures and automated archival snapshots.',
    'service_type' => 'vision-ocr',
  ...
  [
    'id' => 'apitemplate-docs',
    'name' => 'APITemplate Automated Document Generator',
    'description' => 'Enterprise PDF generation from HTML/reusable templates for receipts, certificates, and invoices.',
    'service_type' => 'document-research',
...
// 3. Seed Services
$stmtSvc = $pdo->prepare("INSERT INTO services (
  id, provider_id, category_id, name, description, price, price_unit, delivery_time, latency_ms,
  quality_score, availability, status, endpoint, x402_enabled, is_api_backed, adapter_type,
  auth_type, pricing_model, documentation_url, terms_url, source_url, health_status, env_key_name
) VALUES (
  :id, :provider_id, :category_id, :name, :description, :price, :price_unit, :delivery_time, :latency_ms,
  :quality_score, :availability, :status, :endpoint, :x402_enabled, :is_api_backed, :adapter_type,
  :auth_type, :pricing_model, :documentation_url, :terms_url, :source_url, :health_status, :env_key_name
  ...
  quality_score = VALUES(quality_score), is_api_backed = VALUES(is_api_backed),
  adapter_type = VALUES(adapter_type), health_status = VALUES(health_status)");
...
$services = [
  ...
  [
    ...
    'category_id' => 'data-compute',
    'name' => 'Global Atmospheric Weather Forecast',
    'description' => 'Real-time temperature, wind, humidity, precipitation, and multi-day meteorological forecasting.',
    'price' => 0.25,
    'price_unit' => 'request',
    'delivery_time' => '120ms',
    'latency_ms' => 120,
  ...
  [
    'id' => 'currencylayer-rates',
    'provider_id' => 'currencylayer-fx',
    'category_id' => 'data-compute',
    'name' => 'Live Foreign Exchange & Currency Rates',
    'description' => 'Real-time forex exchange rates and cross-currency conversion with high-frequency updates.',
    'price' => 0.50,
    'price_unit' => 'request',
    'delivery_time' => '145ms',
    'latency_ms' => 145,
    ...
    'availability' => 1,
    'status' => 'AVAILABLE',
    'endpoint' => '/x402/providers/currencylayer-fx/service?serviceId=currencylayer-rates',
    'x402_enabled' => 1,
    'is_api_backed' => 1,
    'adapter_type' => 'currencylayer-fx',
    'auth_type' => 'API_KEY',
    'documentation_url' => 'https://currencylayer.com/documentation',
    'terms_url' => 'https://currencylayer.com/terms',
    'source_url' => 'http://api.currencylayer.com',
    'env_key_name' => 'CURRENCY_LAYER_ACCESS_KEY',
  ],
  [
    'id' => 'ipstack-lookup',
    'provider_id' => 'ipstack-geo',
    'category_id' => 'data-compute',
    'name' => 'Real-Time IP Geolocation & GeoIP Lookup',
    'description' => 'Instant IP to city, country, postal code, timezone, and security risk profile intelligence.',
    'price' => 0.50,
    'price_unit' => 'request',
    'delivery_time' => '110ms',
    'latency_ms' => 110,
    ...
    'x402_enabled' => 1,
    'is_api_backed' => 1,
    'adapter_type' => 'ipstack-geo',
    'auth_type' => 'API_KEY',
    'documentation_url' => 'https://ipstack.com/documentation',
    'terms_url' => 'https://ipstack.com/terms',
    'source_url' => 'http://api.ipstack.com',
    'env_key_name' => 'IPSTACK_ACCESS_KEY',
  ],
  [
    'id' => 'giphy-search',
    'provider_id' => 'giphy-media',
    'category_id' => 'image-video',
    'name' => 'Contextual Animated GIF & Sticker Search',
    'description' => 'Search millions of verified animated GIFs, stickers, and short clips with rating filtering.',
    'price' => 0.25,
    'price_unit' => 'request',
    'delivery_time' => '160ms',
    'latency_ms' => 160,
    ...
    'x402_enabled' => 1,
    'is_api_backed' => 1,
    'adapter_type' => 'giphy-media',
    'auth_type' => 'API_KEY',
    'documentation_url' => 'https://developers.giphy.com/docs/api',
    'terms_url' => 'https://giphy.com/terms',
    'source_url' => 'https://api.giphy.com',
  ...
  [
    ...
    'category_id' => 'vision-ocr',
    'name' => 'High-Fidelity Automated Web Page Screenshot',
    'description' => 'Pixel-perfect headless browser capture with custom viewports, full-page scrolling, and CSS injection.',
    'price' => 0.75,
    'price_unit' => 'job',
    'delivery_time' => '650ms',
    'latency_ms' => 650,
  ...
  [
    ...
    'category_id' => 'data-compute',
    'name' => 'Amazon ASIN Product Catalog & Price Scraper',
    'description' => 'Extract title, price, buy-box offer, rating, review count, and availability for any Amazon ASIN.',
    'price' => 1.00,
    'price_unit' => 'job',
    'delivery_time' => '450ms',
    'latency_ms' => 450,
    ...
    'x402_enabled' => 1,
    'is_api_backed' => 1,
    'adapter_type' => 'amazon-scraper',
    'auth_type' => 'API_KEY',
    'documentation_url' => 'https://rapidapi.com',
    'terms_url' => 'https://rapidapi.com/terms',
    'source_url' => 'https://amazon-data-scraper14.p.rapidapi.com',
  ...
  [
    ...
    'category_id' => 'vision-ocr',
    'name' => 'Cloud Web Monitoring & Visual Snapshot Archive',
    'description' => 'Automated visual state snapshots with webhook notifications and historical change tracking.',
    'price' => 0.75,
    'price_unit' => 'job',
    'delivery_time' => '550ms',
    'latency_ms' => 550,
    ...
    'x402_enabled' => 1,
    'is_api_backed' => 1,
    'adapter_type' => 'blitapp-cloud',
    'auth_type' => 'API_KEY',
    'documentation_url' => 'https://blitapp.com/docs',
    'terms_url' => 'https://blitapp.com/terms',
    'source_url' => 'https://blitapp.com',
    'env_key_name' => 'BLITAPP_API_TOKEN',
  ],
  [
    'id' => 'apitemplate-pdf',
    'provider_id' => 'apitemplate-docs',
    'category_id' => 'document-research',
    'name' => 'Automated PDF Receipt & Document Engine',
    'description' => 'Dynamic PDF rendering from JSON data models for invoices, delivery receipts, and settlement records.',
    'price' => 1.00,
    'price_unit' => 'request',
    'delivery_time' => '380ms',
    'latency_ms' => 380,
    ...
    'x402_enabled' => 1,
    'is_api_backed' => 1,
    'adapter_type' => 'apitemplate-docs',
    'auth_type' => 'API_KEY',
    'documentation_url' => 'https://apitemplate.io/apidocs',
    'terms_url' => 'https://apitemplate.io/terms',
    'source_url' => 'https://rest.apitemplate.io',
    'env_key_name' => 'APITEMPLATE_API_KEY',
  ],
];
foreach ($services as $s) {
    $s['is_api_backed'] = $s['is_api_backed'] ?? 0;
    $s['adapter_type'] = $s['adapter_type'] ?? null;
    $s['auth_type'] = $s['auth_type'] ?? 'NONE';
    $s['pricing_model'] = $s['pricing_model'] ?? 'PER_REQUEST';
    $s['documentation_url'] = $s['documentation_url'] ?? null;
    $s['terms_url'] = $s['terms_url'] ?? null;
    $s['source_url'] = $s['source_url'] ?? null;
    $s['health_status'] = $s['health_status'] ?? 'AVAILABLE';
    $s['env_key_name'] = $s['env_key_name'] ?? null;
    $stmtSvc->execute($s);
}
...
$seedOrders = [
    [
        ...
        'tx' => [
            'id' => 'tx_sepolia_11779302',
            'order_id' => 'ord_sepolia_11779302',
            'transaction_reference' => '0xfefb3725ca1a870d8d1d41ee370ac686becb5f28f39aa790ce6eeb6827f47069',
            'amount' => 4.00,
            'status' => 'SETTLED',
            'risk_score' => 0.02,
            'block_number' => 11779302,
            'network' => 'Ethereum Sepolia Testnet',
            'chain_id' => 11155111,
            'etherscan_url' => 'https://sepolia.etherscan.io/tx/0xfefb3725ca1a870d8d1d41ee370ac686becb5f28f39aa790ce6eeb6827f47069',
        ]
    ],
    [
        'order' => [
